    ...
    return(
        <div className={styles.heading}>
            ...
            <div className={styles["event-notes"]}>
                <p>Substitutions and/or any special request may not be accommodatable. Aburi Sake Don is not available for take-out due to food safety concerns.</p>
                ...
                <p>We truly value the quality of our food and safety of our customers.</p>
            </div>
        </div>
    )
}